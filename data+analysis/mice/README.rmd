...
We converted this .xls file to a .csv fromat. To simpligy manipulation and data analyses, we removed the '#' before RDS, added 'chr' before each marker number,  and  removed the first line, which read  
